...
interface SelectorPinnedScenariosProps {
    scenarios: Scenario[]
    updateScenario: (scenario: Scenario, index: number) => void
}

const SelectorPinnedScenarios = ({ scenarios, updateScenario }: SelectorPinnedScenariosProps): JSX.Element => {
...
export default SelectorPinnedScenarios
