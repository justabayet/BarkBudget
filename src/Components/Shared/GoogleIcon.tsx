...
const GoogleIcon = (props: SvgIconProps): JSX.Element => {
    return (
        <SvgIcon {...props}>
            <svg viewBox="132.248 77.443 179.606 179.606" xmlns="http://www.w3.org/2000/svg">
                <g id="Google-Button" stroke="none" strokeWidth="0" fill="none" fillRule="evenodd" transform="matrix(9.978116, 0, 0, 9.978116, -34.941067, -42.906246)">
